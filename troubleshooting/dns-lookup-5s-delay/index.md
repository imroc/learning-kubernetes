...
* 通过 `nsenter` [进入容器 netns](https://imroc.cc/k8s/trick/debug-network/#%E8%BF%9B%E5%85%A5%E5%AE%B9%E5%99%A8-netns) ，然后使用节点上的 tcpdump 抓 pod 中的包，发现是有的 DNS 请求没有收到响应，超时 5 秒后，再次发送 DNS 请求才成功收到响应。
